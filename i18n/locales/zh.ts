...
const zh = {
  ...
  about: {
    ...
    intro:
      "LeviMC(原LiteLDev)起始于2021年1月27日，最初的目的是开发一款替代BedrockX的Bedrock Dedicated Server插件加载器，也就是LiteLoaderBDS，起初只有三人。\n后来LiteXLoader开发团队的成员也加入了LeviMC，随着时间的推移，团队逐渐壮大。\n在2021年12月9日，LiteLoaderBDS迭代到了v2.0版本，将LiteXLoader并入了LiteLoaderBDS，开始从BedrockX的技术路线上开始发展创新，首次引入了延迟加载机制实现了无需在头文件中调用符号查找函数实现函数的调用，以及完成了自研的头文件生成系统。\n后来由于LiteLoaderBDS的代码库中的历史遗留问题，LeviMC决定从头开始开发一款全新的模组加载器，2023年12月1日，LeviLamina发布了，吸取了LiteLoaderBDS过于耦合的经验教训，采用了模块化的设计理念，极大的提升了加载器的可维护性和扩展性，并且进一步优化了头文件生成，进一步优化了Hook，引入了诸多新特性。",
    missionTitle: "使命",
    missionBody: "让基岩版模组开发变得触手可及。",
    valuesTitle: "我们在乎什么",
    valueOneTitle: "开发者优先",
    valueOneBody:
      "为基岩版模组开发者提供海量原版API，并封装易用的接口，确保模组开发体验顺畅。",
  ...
  features: {
    ...
    title2: "开发模组。",
    description:
      "无论你偏好原生 C++ 的性能，还是脚本语言的灵活性，LeviMC 都能满足你。一个为可靠性和开发体验设计的模块化生态。",
    cta: "准备好构建令人惊叹的项目了吗？",
    ...
    nativeCpp: "原生 C++ 模组",
    nativeCppDesc:
      "使用现代 C++ 编写高性能模组。通过全面的 API 完全访问 BDS 内部。",
    multiLang: "多语言支持",
    multiLangDesc:
      "使用 LegacyScriptEngine 支持 JavaScript、Lua 或 Python。更低的入门门槛，同样的能力。",
    openSource: "开源",
    openSourceDesc:
      "LGPL-3.0 许可证。完全透明，社区驱动。欢迎在 GitHub 上贡献。",
    community: "活跃社区",
  ...
  community: {
    ...
    title2: "社区。",
    description:
      "与构建基岩版模组未来的开发者们交流。获取帮助、分享你的模组、为生态做贡献。",
  ...
  support: {
    ...
    contributeDesc:
      "挑选一个 Issue、完善文档或添加新特性。每个 PR 都能帮助社区。",
